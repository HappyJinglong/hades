...
public interface IStudentAppDetailExt {
	/**
	 ...
	 * @return 数据集合
	 */
	public Map<String,Map<String,Map<String,String>>> queryMapDataByConditionInDiscode1(String termid,String gradeyear,String discode,
			String levelCode,String schoolname, Map<String,Map<String,String>> tongjiDatas);
}

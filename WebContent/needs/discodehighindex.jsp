...
<div id="tjb_main" style="overflow: visible;">
  ...
  <tr class="biaotou_zi">
    ...
    <div style="height:295px;overflow-y:scroll;width:100.85%;">
    <table width="100%" border="0" cellspacing="1" bgcolor="#999999" class="biaoge"> -->
<c:forEach items="${datas}" var="titem">
		<tr>
			  ...
			  <td width="40">${titem.value[KE_CHENG_PINGYU]["totalStudentNum"]}</td>
			  <td width="40">${titem.value[KE_CHENG_PINGYU]["overStudentNum"]}</td>
			  <td width="40">${titem.value[KE_CHENG_PINGYU]["percentOverStudentNum"]}</td>
			  <td width="40">${titem.value[HZ_TRPJ]["totalStudentNum"]}</td>
			  <td width="40">${titem.value[HZ_TRPJ]["overStudentNum"]}</td>
			  <td width="40">${titem.value[HZ_TRPJ]["percentOverStudentNum"]}</td>
			  ...
			  <td width="40">${titem.value[YJXX]["totalStudentNum"]}</td>
			  <td width="40">${titem.value[YJXX]["overStudentNum"]}</td>
			  <td width="40">${titem.value[YJXX]["percentOverStudentNum"]}</td>
			  <td width="40">${titem.value[GXFZ_JBQK]["totalStudentNum"]}</td>
			  <td width="40">${titem.value[GXFZ_JBQK]["overStudentNum"]}</td>
			  <td width="40">${titem.value[GXFZ_JBQK]["percentOverStudentNum"]}</td>
...
<c:if test="${datas!= null&& fn:length(datas) gt 0 }">
  <tr>
    ...
    <td>${tongjiDatas[HZ_TRPJ]["totalStudentNum"]}</td>
    <td>${tongjiDatas[HZ_TRPJ]["overStudentNum"]}</td>
    <td>${tongjiDatas[HZ_TRPJ]["percentOverStudentNum"]}</td>

...
<form action="${ctx}/needs/CityNeedAppraisesAction.a?queryData" method="post">
  ...
  <span >学校：
      <input name="schoolName" id="schoolName" type="text" class="wenben120" value="${schoolName}" /></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             <span >届别：
...
<div id="tjb_main" style="overflow: visible;">
  <div class="top" style="width:1782px">
  ...
  <tr class="biaotou_zi">
    ...
    <div style="height:295px;overflow-y:scroll;width:1798px">

...
<script type="text/javascript">
	...
	window.location.href = "${ctx}/export/shoolFillCount.a?termName="
				+ termName + "&termId=" + termId + "&discode=" + '${discode}'+ "&dStatus=" + dStatus+ "&toSchoolDetail='1'&schoolName=" + schoolName;
	ShowDiv(); 
	 timeId = setInterval(queryDownStatus,1000);
	}
	function toReturn(){
		window.location.href = "${ctx}/appraisalWritedStatics/AppraisalWritedQXAction.a";
	}
	 var dStatus = "";
	 var timeId = "";
	 var count = 0;
...
<div class="dangqianwz" style="padding-top: 1.2%;z-index:1001;">
	<form id="form1" action="${ctx }/appraisalWritedStatics/AppraisalWritedQXAction.a?toQueryQXAppraiseStatics" method="post">
  ...
  <span >学期：
  	<select  name="termId" id="termId" class="  wenziliebiao100">
		<app:newTermId termId="${termId}"/>
            ...
            <span ><input type="button" value="返 回" class="button ml10"  onclick="toReturn();"/></span>
    </form>
</div>
<div id="tjb_main" style="overflow:scroll; width:100%; height:100%">
  <div class="top">

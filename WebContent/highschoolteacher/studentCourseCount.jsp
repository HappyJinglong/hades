...
function checkData(aObj,num){
	...
	var flag = vs%2;
	window.location.href="${ctx}/highschoolteacher/MasterApriseDataAction.a?showAppriseList&&flag="+flag+"&&evaluatetypeid="+'${sectionCode}'+"&&sectionName="+'${sectionName}'+"&&classId="+cid+"&&zsTermId="+'${zsTermId}'+"&&isHistory=1";
}
function chooseTerm(){
	var classid =$("#selectedId option:selected").val();
	var zsTermId = $("#termId option:selected").val();
	ShowDiv();
	window.location.href="${ctx }/highschoolteacher/StudentApprisedAction.a?showStudentCount&&sectionCode="+${sectionCode}+"&&zsTermId="+zsTermId+"&&isHistory=1&&isChooseClass=1&&classId="+classid;
}
//选择班级
function chooseClass(){
	var classid =$("#selectedId option:selected").val();
	ShowDiv();
	window.location.href="${ctx}/highschoolteacher/StudentApprisedAction.a?showStudentCount&sectionCode="+'${sectionCode}'+"&isChooseClass=1&sectionName="+'${sectionName }'+"&classId="+classid;
}
function goIn(aObj,num){
	...
	var flag = vs%2;
	window.location.href="${ctx}/highschoolteacher/MasterApriseDataAction.a?showAppriseList&&flag="+flag+"&&evaluatetypeid="+'${sectionCode}'+"&&sectionName="+'${sectionName}'+"&&classId="+classid+"&&zsTermId="+'${zsTermId}'+"&&isHistory=1&&subject="+subId;
}
</script>
<body>

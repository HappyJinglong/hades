...
function exportExcel()
{
	...
	dStatus = uuid(); 
	window.location.href = "${ctx}/export/TotalCountExportAction.a?gradeName="
				+ gradeName
				+ "&dStatus=" 
				+ dStatus
				+ "&gradeid="
...
<div class="dangqianwz" style="z-index: 1001;position: fixed;width: 99%">
    <form action="${ctx}/total/TotalDatasNumAction.a?queryData" method="post">
	<span class="fl">当前位置：数据填写总体情况</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <span >学校：
       <input id="schoolName" name="schoolName" type="text" class="wenben120" value="${schoolName}" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div id="tjb_main" style="overflow: visible;">
  ...
  <table width="600%" border="0" cellspacing="1" bgcolor="#999999" class="biaoge">
   ...
   <tr class="biaotou_zi">
     ...
     <td colspan="8">新学期伊始的我</td>
     <td colspan="12">学期结束的我</td>
     <td colspan="21">思想道德</td>
     <td colspan="21">学业成就</td>
     <td colspan="21">合作与交流</td>
     <td colspan="20">运动与健康</td>
     <td colspan="21">审美与表现</td>
     <td colspan="22">综合实践活动</td>
     <td colspan="21">个性发展</td>
     </tr>
   <tr class="biaotou_zi">
     ...
     <td colspan="13">研究性学习</td>
     <td colspan="9">社区服务与实践活动</td>
     <td colspan="4">自我评价</td>
     <td colspan="12">他人评价</td>
...
<c:forEach items="${datas}" var="titem">
  <tr>
   ...
   <td>${titem.value[START_WDFZMB]["totalStudentNum"]}</td>
   <td>${titem.value[START_WDFZMB]["overStudentNum"]}</td>
   <td>${titem.value[START_WDFZMB]["percentOverStudentNum"]}</td>
   <td>${titem.value[START_WDFZMB]["overAppriseNum"]}</td>
   ...
   <td>${titem.value[SX_TRPJ_TX]["totalStudentNum"]}</td>
   <td>${titem.value[SX_TRPJ_TX]["overStudentNum"]}</td>
   <td>${titem.value[SX_TRPJ_TX]["percentOverStudentNum"]}</td>
   <td>${titem.value[SX_TRPJ_TX]["overAppriseNum"]}</td>
   <td>${titem.value[SX_TRPJ_JS]["totalStudentNum"]}</td>
   <td>${titem.value[SX_TRPJ_JS]["overStudentNum"]}</td>
   <td>${titem.value[SX_TRPJ_JS]["percentOverStudentNum"]}</td>
   <td>${titem.value[SX_TRPJ_JS]["overAppriseNum"]}</td>
   <td>${titem.value[SX_TRPJ_JZ]["totalStudentNum"]}</td>
   <td>${titem.value[SX_TRPJ_JZ]["overStudentNum"]}</td>
   <td>${titem.value[SX_TRPJ_JZ]["percentOverStudentNum"]}</td>
   <td>${titem.value[SX_TRPJ_JZ]["overAppriseNum"]}</td>
   ...
   <td>${titem.value[XY_TRPJ_KECHENG_PINGYU]["totalStudentNum"]}</td>
   <td>${titem.value[XY_TRPJ_KECHENG_PINGYU]["overStudentNum"]}</td>
   <td>${titem.value[XY_TRPJ_KECHENG_PINGYU]["percentOverStudentNum"]}</td>
   <td>${titem.value[XY_TRPJ_KECHENG_PINGYU]["overAppriseNum"]}</td>
   <td>${titem.value[XY_TRPJ_TX]["totalStudentNum"]}</td>
   <td>${titem.value[XY_TRPJ_TX]["overStudentNum"]}</td>
   <td>${titem.value[XY_TRPJ_TX]["percentOverStudentNum"]}</td>
   <td>${titem.value[XY_TRPJ_TX]["overAppriseNum"]}</td>
   <td>${titem.value[XY_TRPJ_JZ]["totalStudentNum"]}</td>
   <td>${titem.value[XY_TRPJ_JZ]["overStudentNum"]}</td>
   <td>${titem.value[XY_TRPJ_JZ]["percentOverStudentNum"]}</td>
   <td>${titem.value[XY_TRPJ_JZ]["overAppriseNum"]}</td>
   <td>${titem.value[XY_XKZPZS]["totalStudentNum"]}</td>
   <td>${titem.value[XY_XKZPZS]["overStudentNum"]}</td>
   <td>${titem.value[XY_XKZPZS]["percentOverStudentNum"]}</td>
   <td>${titem.value[XY_XKZPZS]["overAppriseNum"]}</td>
   <td>${titem.value[XY_XKZPZS]["attchFileNum"]}</td>
   ...
   <td>${titem.value[HZ_TRPJ_TX]["totalStudentNum"]}</td>
   <td>${titem.value[HZ_TRPJ_TX]["overStudentNum"]}</td>
   <td>${titem.value[HZ_TRPJ_TX]["percentOverStudentNum"]}</td>
   <td>${titem.value[HZ_TRPJ_TX]["overAppriseNum"]}</td>
   <td>${titem.value[HZ_TRPJ_JS]["totalStudentNum"]}</td>
   <td>${titem.value[HZ_TRPJ_JS]["overStudentNum"]}</td>
   <td>${titem.value[HZ_TRPJ_JS]["percentOverStudentNum"]}</td>
   <td>${titem.value[HZ_TRPJ_JS]["overAppriseNum"]}</td>
   <td>${titem.value[HZ_TRPJ_JZ]["totalStudentNum"]}</td>
   <td>${titem.value[HZ_TRPJ_JZ]["overStudentNum"]}</td>
   <td>${titem.value[HZ_TRPJ_JZ]["percentOverStudentNum"]}</td>
   <td>${titem.value[HZ_TRPJ_JZ]["overAppriseNum"]}</td>
   ...
   <td>${titem.value[YDJK_TRPJ_TX]["totalStudentNum"]}</td>
   <td>${titem.value[YDJK_TRPJ_TX]["overStudentNum"]}</td>
   <td>${titem.value[YDJK_TRPJ_TX]["percentOverStudentNum"]}</td>
   <td>${titem.value[YDJK_TRPJ_TX]["overAppriseNum"]}</td>
   <td>${titem.value[YDJK_TRPJ_JS]["totalStudentNum"]}</td>
   <td>${titem.value[YDJK_TRPJ_JS]["overStudentNum"]}</td>
   <td>${titem.value[YDJK_TRPJ_JS]["percentOverStudentNum"]}</td>
   <td>${titem.value[YDJK_TRPJ_JS]["overAppriseNum"]}</td>
   <td>${titem.value[YDJK_TRPJ_JZ]["totalStudentNum"]}</td>
   <td>${titem.value[YDJK_TRPJ_JZ]["overStudentNum"]}</td>
   <td>${titem.value[YDJK_TRPJ_JZ]["percentOverStudentNum"]}</td>
   <td>${titem.value[YDJK_TRPJ_JZ]["overAppriseNum"]}</td>
   <td>${titem.value[YDJK_TZJK]["totalStudentNum"]}</td>
   <td>${titem.value[YDJK_TZJK]["overStudentNum"]}</td>
   <td>${titem.value[YDJK_TZJK]["percentOverStudentNum"]}</td>
   <td>${titem.value[YDJK_TZJK]["overAppriseNum"]}</td>
   ...
   <td>${titem.value[SMYBX_TRPJ_TX]["totalStudentNum"]}</td>
   <td>${titem.value[SMYBX_TRPJ_TX]["overStudentNum"]}</td>
   <td>${titem.value[SMYBX_TRPJ_TX]["percentOverStudentNum"]}</td>
   <td>${titem.value[SMYBX_TRPJ_TX]["overAppriseNum"]}</td>
   <td>${titem.value[SMYBX_TRPJ_JS]["totalStudentNum"]}</td>
   <td>${titem.value[SMYBX_TRPJ_JS]["overStudentNum"]}</td>
   <td>${titem.value[SMYBX_TRPJ_JS]["percentOverStudentNum"]}</td>
   <td>${titem.value[SMYBX_TRPJ_JS]["overAppriseNum"]}</td>
   <td>${titem.value[SMYBX_TRPJ_JZ]["totalStudentNum"]}</td>
   <td>${titem.value[SMYBX_TRPJ_JZ]["overStudentNum"]}</td>
   <td>${titem.value[SMYBX_TRPJ_JZ]["percentOverStudentNum"]}</td>
   <td>${titem.value[SMYBX_TRPJ_JZ]["overAppriseNum"]}</td>
   ...
   <td>${titem.value[ZHSJ_YJXX_JBQK]["totalStudentNum"]}</td>
   <td>${titem.value[ZHSJ_YJXX_JBQK]["overStudentNum"]}</td>
   <td>${titem.value[ZHSJ_YJXX_JBQK]["percentOverStudentNum"]}</td>
   <td>${titem.value[ZHSJ_YJXX_JBQK]["overAppriseNum"]}</td>
   <td>${titem.value[ZHSJ_YJXX_YJCG]["totalStudentNum"]}</td>
   <td>${titem.value[ZHSJ_YJXX_YJCG]["overStudentNum"]}</td>
   <td>${titem.value[ZHSJ_YJXX_YJCG]["percentOverStudentNum"]}</td>
   <td>${titem.value[ZHSJ_YJXX_YJCG]["overAppriseNum"]}</td>
   <td>${titem.value[ZHSJ_YJXX_YJCG]["attchFileNum"]}</td>
   <td>${titem.value[ZHSJ_YJXX_ZWPJ]["totalStudentNum"]}</td>
   <td>${titem.value[ZHSJ_YJXX_ZWPJ]["overStudentNum"]}</td>
   <td>${titem.value[ZHSJ_YJXX_ZWPJ]["percentOverStudentNum"]}</td>
   <td>${titem.value[ZHSJ_YJXX_ZWPJ]["overAppriseNum"]}</td>
   <td>${titem.value[ZHSJ_SQFWSHSJ_JBQK]["totalStudentNum"]}</td>
   <td>${titem.value[ZHSJ_SQFWSHSJ_JBQK]["overStudentNum"]}</td>
   <td>${titem.value[ZHSJ_SQFWSHSJ_JBQK]["percentOverStudentNum"]}</td>
   <td>${titem.value[ZHSJ_SQFWSHSJ_JBQK]["overAppriseNum"]}</td>
  	<td>${titem.value[ZHSJ_SQFWSHSJ_JBQK]["attchFileNum"]}</td>
   <td>${titem.value[ZHSJ_SQFWSHSJ_ZWPJ]["totalStudentNum"]}</td>
   <td>${titem.value[ZHSJ_SQFWSHSJ_ZWPJ]["overStudentNum"]}</td>
   <td>${titem.value[ZHSJ_SQFWSHSJ_ZWPJ]["percentOverStudentNum"]}</td>
   <td>${titem.value[ZHSJ_SQFWSHSJ_ZWPJ]["overAppriseNum"]}</td>
   ...
   <td>${titem.value[GXFZ_TRPJ_TX]["totalStudentNum"]}</td>
   <td>${titem.value[GXFZ_TRPJ_TX]["overStudentNum"]}</td>
   <td>${titem.value[GXFZ_TRPJ_TX]["percentOverStudentNum"]}</td>
   <td>${titem.value[GXFZ_TRPJ_TX]["overAppriseNum"]}</td>
   <td>${titem.value[GXFZ_TRPJ_JS]["totalStudentNum"]}</td>
   <td>${titem.value[GXFZ_TRPJ_JS]["overStudentNum"]}</td>
   <td>${titem.value[GXFZ_TRPJ_JS]["percentOverStudentNum"]}</td>
   <td>${titem.value[GXFZ_TRPJ_JS]["overAppriseNum"]}</td>
   <td>${titem.value[GXFZ_TRPJ_JZ]["totalStudentNum"]}</td>
   <td>${titem.value[GXFZ_TRPJ_JZ]["overStudentNum"]}</td>
   <td>${titem.value[GXFZ_TRPJ_JZ]["percentOverStudentNum"]}</td>
   <td>${titem.value[GXFZ_TRPJ_JZ]["overAppriseNum"]}</td>
   ...
   <td>${tongjiDatas[START_WDFZMB]["overAppriseNum"]}</td>
   ...
   <td>${tongjiDatas[SX_TRPJ_TX]["totalStudentNum"]}</td>
   <td>${tongjiDatas[SX_TRPJ_TX]["overStudentNum"]}</td>
   <td>${tongjiDatas[SX_TRPJ_TX]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[SX_TRPJ_TX]["overAppriseNum"]}</td>
   <td>${tongjiDatas[SX_TRPJ_JS]["totalStudentNum"]}</td>
   <td>${tongjiDatas[SX_TRPJ_JS]["overStudentNum"]}</td>
   <td>${tongjiDatas[SX_TRPJ_JS]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[SX_TRPJ_JS]["overAppriseNum"]}</td>
   <td>${tongjiDatas[SX_TRPJ_JZ]["totalStudentNum"]}</td>
   <td>${tongjiDatas[SX_TRPJ_JZ]["overStudentNum"]}</td>
   <td>${tongjiDatas[SX_TRPJ_JZ]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[SX_TRPJ_JZ]["overAppriseNum"]}</td>
   ...
   <td>${tongjiDatas[XY_TRPJ_TX]["totalStudentNum"]}</td>
   <td>${tongjiDatas[XY_TRPJ_TX]["overStudentNum"]}</td>
   <td>${tongjiDatas[XY_TRPJ_TX]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[XY_TRPJ_TX]["overAppriseNum"]}</td>
   ...
   <td>${tongjiDatas[XY_TRPJ_KECHENG_PINGYU]["overAppriseNum"]}</td>
   <td>${tongjiDatas[XY_TRPJ_JZ]["totalStudentNum"]}</td>
   <td>${tongjiDatas[XY_TRPJ_JZ]["overStudentNum"]}</td>
   <td>${tongjiDatas[XY_TRPJ_JZ]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[XY_TRPJ_JZ]["overAppriseNum"]}</td>
   <td>${tongjiDatas[XY_XKZPZS]["totalStudentNum"]}</td>
   <td>${tongjiDatas[XY_XKZPZS]["overStudentNum"]}</td>
   <td>${tongjiDatas[XY_XKZPZS]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[XY_XKZPZS]["overAppriseNum"]}</td>
   <td>${tongjiDatas[XY_XKZPZS]["attchFileNum"]}</td>
   ...
   <td>${tongjiDatas[HZ_TRPJ_TX]["overAppriseNum"]}</td>
   <td>${tongjiDatas[HZ_TRPJ_JS]["totalStudentNum"]}</td>
   <td>${tongjiDatas[HZ_TRPJ_JS]["overStudentNum"]}</td>
   <td>${tongjiDatas[HZ_TRPJ_JS]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[HZ_TRPJ_JS]["overAppriseNum"]}</td>
   <td>${tongjiDatas[HZ_TRPJ_JZ]["totalStudentNum"]}</td>
   <td>${tongjiDatas[HZ_TRPJ_JZ]["overStudentNum"]}</td>
   <td>${tongjiDatas[HZ_TRPJ_JZ]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[HZ_TRPJ_JZ]["overAppriseNum"]}</td>
   ...
   <td>${tongjiDatas[YDJK_TRPJ_TX]["totalStudentNum"]}</td>
   <td>${tongjiDatas[YDJK_TRPJ_TX]["overStudentNum"]}</td>
   <td>${tongjiDatas[YDJK_TRPJ_TX]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[YDJK_TRPJ_TX]["overAppriseNum"]}</td>
   <td>${tongjiDatas[YDJK_TRPJ_JS]["totalStudentNum"]}</td>
   <td>${tongjiDatas[YDJK_TRPJ_JS]["overStudentNum"]}</td>
   <td>${tongjiDatas[YDJK_TRPJ_JS]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[YDJK_TRPJ_JS]["overAppriseNum"]}</td>
   <td>${tongjiDatas[YDJK_TRPJ_JZ]["totalStudentNum"]}</td>
   <td>${tongjiDatas[YDJK_TRPJ_JZ]["overStudentNum"]}</td>
   <td>${tongjiDatas[YDJK_TRPJ_JZ]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[YDJK_TRPJ_JZ]["overAppriseNum"]}</td>
   <td>${tongjiDatas[YDJK_TZJK]["totalStudentNum"]}</td>
   <td>${tongjiDatas[YDJK_TZJK]["overStudentNum"]}</td>
   <td>${tongjiDatas[YDJK_TZJK]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[YDJK_TZJK]["overAppriseNum"]}</td>
   ...
   <td>${tongjiDatas[SMYBX_TRPJ_TX]["totalStudentNum"]}</td>
   <td>${tongjiDatas[SMYBX_TRPJ_TX]["overStudentNum"]}</td>
   <td>${tongjiDatas[SMYBX_TRPJ_TX]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[SMYBX_TRPJ_TX]["overAppriseNum"]}</td>
   <td>${tongjiDatas[SMYBX_TRPJ_JS]["totalStudentNum"]}</td>
   <td>${tongjiDatas[SMYBX_TRPJ_JS]["overStudentNum"]}</td>
   <td>${tongjiDatas[SMYBX_TRPJ_JS]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[SMYBX_TRPJ_JS]["overAppriseNum"]}</td>
   <td>${tongjiDatas[SMYBX_TRPJ_JZ]["totalStudentNum"]}</td>
   <td>${tongjiDatas[SMYBX_TRPJ_JZ]["overStudentNum"]}</td>
   <td>${tongjiDatas[SMYBX_TRPJ_JZ]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[SMYBX_TRPJ_JZ]["overAppriseNum"]}</td>
   ...
   <td>${tongjiDatas[ZHSJ_YJXX_JBQK]["overAppriseNum"]}</td>
   <td>${tongjiDatas[ZHSJ_YJXX_YJCG]["totalStudentNum"]}</td>
   <td>${tongjiDatas[ZHSJ_YJXX_YJCG]["overStudentNum"]}</td>
   <td>${tongjiDatas[ZHSJ_YJXX_YJCG]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[ZHSJ_YJXX_YJCG]["overAppriseNum"]}</td>
   <td>${tongjiDatas[ZHSJ_YJXX_YJCG]["attchFileNum"]}</td>
   <td>${tongjiDatas[ZHSJ_YJXX_ZWPJ]["totalStudentNum"]}</td>
   <td>${tongjiDatas[ZHSJ_YJXX_ZWPJ]["overStudentNum"]}</td>
   <td>${tongjiDatas[ZHSJ_YJXX_ZWPJ]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[ZHSJ_YJXX_ZWPJ]["overAppriseNum"]}</td>
   <td>${tongjiDatas[ZHSJ_SQFWSHSJ_JBQK]["totalStudentNum"]}</td>
   <td>${tongjiDatas[ZHSJ_SQFWSHSJ_JBQK]["overStudentNum"]}</td>
   <td>${tongjiDatas[ZHSJ_SQFWSHSJ_JBQK]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[ZHSJ_SQFWSHSJ_JBQK]["overAppriseNum"]}</td>
  	<td>${tongjiDatas[ZHSJ_SQFWSHSJ_JBQK]["attchFileNum"]}</td>
   <td>${tongjiDatas[ZHSJ_SQFWSHSJ_ZWPJ]["totalStudentNum"]}</td>
   <td>${tongjiDatas[ZHSJ_SQFWSHSJ_ZWPJ]["overStudentNum"]}</td>
   <td>${tongjiDatas[ZHSJ_SQFWSHSJ_ZWPJ]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[ZHSJ_SQFWSHSJ_ZWPJ]["overAppriseNum"]}</td>
   ...
   <td>${tongjiDatas[GXFZ_TRPJ_TX]["totalStudentNum"]}</td>
   <td>${tongjiDatas[GXFZ_TRPJ_TX]["overStudentNum"]}</td>
   <td>${tongjiDatas[GXFZ_TRPJ_TX]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[GXFZ_TRPJ_TX]["overAppriseNum"]}</td>
   <td>${tongjiDatas[GXFZ_TRPJ_JS]["totalStudentNum"]}</td>
   <td>${tongjiDatas[GXFZ_TRPJ_JS]["overStudentNum"]}</td>
   <td>${tongjiDatas[GXFZ_TRPJ_JS]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[GXFZ_TRPJ_JS]["overAppriseNum"]}</td>
   <td>${tongjiDatas[GXFZ_TRPJ_JZ]["totalStudentNum"]}</td>
   <td>${tongjiDatas[GXFZ_TRPJ_JZ]["overStudentNum"]}</td>
   <td>${tongjiDatas[GXFZ_TRPJ_JZ]["percentOverStudentNum"]}</td>
   <td>${tongjiDatas[GXFZ_TRPJ_JZ]["overAppriseNum"]}</td>

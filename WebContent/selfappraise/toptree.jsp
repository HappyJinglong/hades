...
<body>
 <div class="xue_zuti">
 	<span  id="span2"  class="span1"><a id="student" href="${ctx}/selfappraise/SelfAppAction.a?choicenum=1008&evaluateType=9010" class="lanmu2" target="hit_a" onclick="showStudentMenu()">研究性学习</a></span>
 	<span  id="span1" class="span2"><a id="teacher"   href="${ctx}/selfappraise/SelfAppAction.a?choicenum=1008&evaluateType=9020" class="lanmu2" target="hit_a" onclick="showTeacherMenu()" >社区服务</a></span>	
    <span  id="span3" class="span2"><a id="student1"  href="${ctx}/selfappraise/SelfAppAction.a?choicenum=1008&evaluateType=9030" class="lanmu2" target="hit_a" onclick="showStudent1Menu()" >社会实践活动 </a></span>	 
 </div>
</body>
</html>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<un:bind var="PLAY_SELF_APPRAISAL" type="com.flyrish.hades.common.Constant"
...
<body>
<input type="hidden" name="evaluateType1" id="evaluateType1" value="${PLAY_SELF_APPRAISAL}"> 
<%@ include file="/common/div.jsp"%>
		<div class="dangqianwz">
	<span>当前位置：自我评价->运动与健康</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<span>学期：

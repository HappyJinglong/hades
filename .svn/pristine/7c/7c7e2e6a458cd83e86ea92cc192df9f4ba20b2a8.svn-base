...
<!--                <option selected="selected">全部&nbsp;&nbsp;&nbsp;&nbsp;</option> -->
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <span ><input type="button" value="查 询" onclick="query()" class="button ml10" /></span>&nbsp;&nbsp;&nbsp;

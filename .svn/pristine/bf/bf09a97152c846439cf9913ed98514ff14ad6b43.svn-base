		...
		<div class="down mt18 pb30">
			...
			<div id="top">
				<table width="100%" border="0" cellspacing="1" bgcolor="#999999"
					...
					<tr class="title_bg">
						<td colspan="3">研究性学习内容(高中三年内要求至少填写两次)</td>
					</tr>
					<tr id="new_tr">
					...
					<tr>
						<td colspan="2" id="new_td" class="h50" style="width: 90%;">
							<div class="downbox mt18">
								<span class="fl wenben86left">题目：</span> <input type="text"
									class="fl wenbenkuang670" id="new_tm" style="background: transparent; float:left;color:#BCBCBC;cursor:text;"  maxlength="30" onfocus="turnon30(event)" onblur="turnoff30(event)" value="最多输入30字"  />
							</div>
							<div class="downbox mt18">
								<span class="fl wenben86left">合伙人：</span> <input type="text"
									class="fl wenbenkuang670" id="new_hhr" style="background: transparent;float:left;color:#BCBCBC;cursor:text;"  maxlength="120" onfocus="turnon120(event)" onblur="turnoff120(event)" value="最多输入120字" />
							</div>
							<div class="downbox mt18">
								<span class="fl wenben86left">总学时数：</span> <input type="text"
									class="fl wenbenkuang100" id="new_zxss" style="background: transparent;float:left;color:#BCBCBC;cursor:text;" maxlength="120" onfocus="turnon120(event)" onblur="turnoff120(event)" value="最多输入120字" />
							</div>
							<div class="downbox mt18">
								<span class="fl wenben86left">实施路径：</span> <input type="text"
									class="fl wenbenkuang670" id="new_sslj" style="background: transparent;float:left;color:#BCBCBC;cursor:text;" maxlength="120" onfocus="turnon120(event)" onblur="turnoff120(event)" value="最多输入120字" />
							</div>

							<div class="downbox mt18">
								<span class="fl wenben86left">内容摘要：</span>
								<textarea id="new_content" class="wenbenyu112" style="background: transparent; float:left;color:#BCBCBC;cursor:text;" onfocus="turnon700(event)" onblur="turnoff700(event)">最多输入700字</textarea>
							</div>
							<div id="new_attach">
							...
							<form method="post" id="new_frm">
								<span class="fl wenben85left" style="color: black;font-weight: bold;font-size: 13px;">附件(研究性学习材料)：</span> 
									<input name='new_fileField' id='new_fileField' type="file"
										  style="position:absolute;background: transparent;left:160px;" />
									<input id="new_upload" class="shangchuan ml10" type="button" value="上 传" 
									onclick="checkupload(event)"
										 style="position:absolute;left:400px;border-bottom: 1px solid #000;border-right: 1px solid #000;border-top: 1px solid #D7D7D7;border-left: 1px solid #D7D7D7;color:#272222;background-color:#279F46;height:20px" />  
									<div style="position:absolute;left:500px;"><span id="new_tp" style="margin-right: 20px;">0%</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span style="font-size:10px;">格式仅限doc、docx、txt、jpg、pdf、pps、ppsx、ppt和pptx</span></div>
							</form>
							</div>
							<div class="downbox mt18" id="new_textareatd">
								<span  class="fl wenben86left" style="background: transparent;width:133px">自我评价：</span>
								<textarea class="wenbenyu111" id="new_contentapp" onblur="checksaveapp(event)" style="background: transparent;float:left;color:#BCBCBC;cursor:text;"  onfocus="turnon600(event)"  >最多输入600字</textarea>
								...
								<input type="button"  title="添 加" id="new_addapp" style="margin-left:91.05%" class="xgg fl ml10" onclick="addtextarea(event)"/>
							</div>
						</td>
						<td width="10%" height="191" class="bg_eee" id="bg_eee_4_2">
			...
			<div id="top">
				<table width="100%" border="0" cellspacing="1" bgcolor="#999999"
					class="biaoge" id="new_table">
					<tr class="title_bg">
						<td colspan="3">研究性学习内容<span class="red">*</span></td>
					</tr>
					<%int i=1;%>
					...
					<tr>
						<td colspan="2" id="${list.practiceid}_td" class="h50" style="background:#eee;width: 90%;">
							<div class="downbox mt18">
								<span class="fl wenben86left">题目：</span> <input type="text"
									class="fl wenbenkuang670" id="${list.practiceid}_tm"  style="background: transparent;" maxlength="30"  onfocus="turnon30(event)" onblur="turnoff30(event)"
								 	value="${list.item6}" onclick="changeBackgroundtd('${list.practiceid}')"/>
							</div>
							<div class="downbox mt18">
								<span class="fl wenben86left">合伙人：</span> <input type="text"
									class="fl wenbenkuang670" id="${list.practiceid}_hhr" style="background: transparent;" maxlength="120" onfocus="turnon120(event)" onblur="turnoff120(event)"
								 	value="${list.item7}" onclick="changeBackgroundtd('${list.practiceid}')"/>
							</div>
							<div class="downbox mt18">
								<span class="fl wenben86left">总学时数：</span> <input type="text"
									class="fl wenbenkuang100" id="${list.practiceid}_zxss" style="background: transparent;" maxlength="120" onfocus="turnon120(event)" onblur="turnoff120(event)"
								 	value="${list.item2}" onclick="changeBackgroundtd('${list.practiceid}')"/>
							</div>
							<div class="downbox mt18">
								<span class="fl wenben86left">实施路径：</span> <input type="text"
									class="fl wenbenkuang670" id="${list.practiceid}_sslj" style="background: transparent;" maxlength="120" onfocus="turnon120(event)" onblur="turnoff120(event)"
								 	value="${list.item9}" onclick="changeBackgroundtd('${list.practiceid}')"/>
							</div>
							<div class="downbox mt18">
								<span class="fl wenben86left">内容摘要：</span>
								<textarea id="${list.practiceid}_content" class="wenbenyu112" 
								idvalue="${list.item1}"  onfocus="turnon700(event)" onblur="turnoff700(event)"
...
<%-- 									<input name='${list.practiceid}_textfield' id='${list.practiceid}_textfield' type="text"
							...
							<div class="downbox mt18"  id="${list.practiceid}_textareatd">
								<span class="fl wenben86left" style="width:133px;">自我评价：</span>
								<c:if test="${not empty list.practiceappraisalList}">
								<c:forEach items="${list.practiceappraisalList}" var="practiceappraisalList">
									<!--onblur="checksaveapp(event)" onfocus="changeBackgroundtd('${list.practiceid}')"   -->
									...
									<input type="button" title="删除" class="del fl ml10" id="${practiceappraisalList.appraisalid}_deleteapp" onclick="deletepracticeappraisal(event)" style="margin-top:45px;margin-left:1px;"/>
								</c:forEach>
								</c:if>
								<c:if test="${empty list.practiceappraisalList}">
									...
									<input type="button" title="删除" class="del fl ml10" id="${list.practiceid}_deleteapp" onclick="deletepracticeappraisal(event)" style="margin-top:45px;margin-left:1px;"/>
								</c:if>
								 <input type="button"  title="添 加" id="${list.practiceid}_addapp" style="margin-left:91.05%" class="xgg fl ml10" onclick="addtextarea(event)"/>
							</div>

						</td>
						<td width="10%" height="191" id="bg_eee_4_2" class="bg_eee" style="margin:0px auto;float:none">
...
function saveall(blur,check,event){//blur为1是点击保存按钮,0是失去焦点保存;check点击上传为1，不点击上传为0
	...
	arr = idd.split("_");
	id = arr[0];
	var new_tm = $("#new_tm").val();
	var new_hhr = $("#new_hhr").val();
	...
	if($("#new_tm").val()=="最多输入30字"){new_tm=""}
	if($("#new_hhr").val()=="最多输入120字"){new_hhr=""}
	if($("#new_zxss").val()=="最多输入120字"){new_zxss=""}
	if($("#new_sslj").val()=="最多输入120字"){new_sslj=""}
	if($("#new_content").val()=="最多输入700字"){new_content=""}
	var type = "9010"
			...
			if(saveNow == 0){
				...
				saveNow =1;
				if(blur=="1"&&check=="0"){
					 if($("#new_tm").val().trim()!=0&&$("#new_tm").val()!="最多输入30字"){
						 
							if($("#new_content").val().length<=700){
								if($("#new_tm").val()=="最多输入30字"){$("#new_tm").val("");}
								if($("#new_hhr").val()=="最多输入120字"){$("#new_hhr").val("");}
								if($("#new_zxss").val()=="最多输入120字"){$("#new_zxss").val("");}
								if($("#new_sslj").val()=="最多输入120字"){$("#new_sslj").val("");}
								if($("#new_content").val()=="最多输入700字"){$("#new_content").val("");}
								...
								Ext.Ajax.request({
									...
									success:function(response,options){
										...
										if(response.responseText=="##"){
											...
											$("#new_content").bind("focus",function(){
											...
											if(blur=="1"){
												if(check!="0"){
													if($("#"+saveid+"_content").val()==""){
														$("#"+saveid+"_content").val("最多输入700字")
														$("#"+saveid+"_content").css({color:"#BCBCBC",float:"left",cursor:"text"});
													}
													if($("#"+saveid+"_tm").val()==""){
														$("#"+saveid+"_tm").val("最多输入30字")
														$("#"+saveid+"_tm").css({color:"#BCBCBC",float:"left",cursor:"text"});
													}
													if($("#"+saveid+"_hhr").val()==""){
														$("#"+saveid+"_hhr").val("最多输入120字")
														$("#"+saveid+"_hhr").css({color:"#BCBCBC",float:"left",cursor:"text"});
													}
													if($("#"+saveid+"_zxss").val()==""){
												...
												if(check!="1"){
													...
													alert_save_success("研究性学习",$("#"+saveid+"_num").html());
												}
											}else{
												saveNow = 0;
											}
								...
								success:function(response,options){
									...
									if(response.responseText=="##"){
										...
										$("#new_contentapp").bind("focus",function(){
										 ...
										 /*if($("#new_contentapp")!='undefinded'&&$("#new_contentapp")!=null){
											$("#new_contentapp").attr("id",saveid+"_contentapp");
										}
										if($("#new_deleteapp")!='undefinded'&&$("#new_deleteapp")!=null){
											$("#new_deleteapp").attr("id",saveid+"_deleteapp");
										} */
										 $("#"+saveid+"_upload").bind("click",function(){
											return beforeSubmitForm("old_fileField",saveid+"_frm",saveid+"_old_uuid",saveid+"_tp",saveid);
...
function updatePractices(id){
	if(is600app==0){
		if($("#"+id+"_tm").val().trim().length!=0&&$("#"+id+"_tm").val()!="最多输入30字"){
			if($("#"+id+"_content").val().length<=700){
				if($("#"+id+"_tm").val()=="最多输入30字"){$("#"+id+"_tm").val("");}
				if($("#"+id+"_hhr").val()=="最多输入120字"){$("#"+id+"_hhr").val("");}
				if($("#"+id+"_zxss").val()=="最多输入120字"){$("#"+id+"_zxss").val("");}
				if($("#"+id+"_sslj").val()=="最多输入120字"){$("#"+id+"_sslj").val("");}
				if($("#"+id+"_content").val()=="最多输入700字"){$("#"+id+"_content").val("");}
				if($("#new_contentapp").val()=="最多输入600字"){$("#new_contentapp").val("");}
				...
				Ext.Ajax.request({
					...
					success:function(response,options){
						...
						if(temp=="##"){
							...
							alert_save_success("研究性学习",$("#"+id+"_num").html());
						}
					},
					params : {
						id : id,
...
function deletepracticeappraisal1(id){
	var idd=id+"_contentapp";
				...
				Ext.Ajax.request({
					...
					success:function(response,options){
						...
						if(response.responseText=="##"){
							...
							if(isDelete == 1){
								deletepracticeappraisal1(saveid)
							}
							issaveapp = 0;
						}
						is600app = 0;
...
function checksaveapp(event){//保存自我评价
   ii=0;
	...
	id = arr[0];
	var arr1 = new Array();
	var idd1 = $("#"+idd).parent().parent().attr("id");
	arr1 = idd1.split("_");
	id1 = arr1[0];
	 				...
	 				if(document.getElementById(name).value!=""){
	 					...
	 					if(pname.length<=25){
	 						if((ftype!=null&&ftype!="")&&(ftype=="doc"||ftype=="docx"||ftype=="txt"||ftype=="jpg"||ftype=="pdf"||ftype=="pps"||ftype=="ppsx"||ftype=="ppt"||ftype=="pptx")){
	 							...
	 							alert("研究性学习 栏目"+$("#"+id+"_num").html()+": 附件名重复!");	
	 							$("#"+id+"_upload").attr("disabled",false);
	 							$('#old_fileField').attr("id",beforeid);
	 							}
	 						}else{
...
function deleteselfall(event){
	var width = $("#bg_eee_4_2").attr("width");
									...
									if(tr.size()==4){
										...
										$("#"+idd+"_tr").remove();
										 ...
										 str+="<tr id='new_tr'><td width='10%' height='40' id='new_num' class='bg_eee'>"+"1"+"</td><td colspan='2' class='youjuzhong pr20 bg_eee'>"
										 	...
										 	+"<div class='downbox mt18'><span class='fl wenben86left'>题目：</span> <input type='text' class='fl wenbenkuang670' id='new_tm'  maxlength='30' style='background: transparent;float:left;color:#BCBCBC;cursor:text;' onfocus='turnon30(event)' onblur='turnoff30(event)' value='最多输入30字'/></div>"
										 	+"<div class='downbox mt18'><span class='fl wenben86left'>合伙人：</span> <input type='text' class='fl wenbenkuang670' id='new_hhr'  maxlength='120' style='background: transparent;float:left;color:#BCBCBC;cursor:text;' onfocus='turnon120(event)' onblur='turnoff120(event)' value='最多输入120字'/></div>"
										 	+"<div class='downbox mt18'><span class='fl wenben86left'>总学时数：</span> <input type='text' class='fl wenbenkuang100' id='new_zxss'  maxlength='120' style='background: transparent;float:left;color:#BCBCBC;cursor:text;' onfocus='turnon120(event)' onblur='turnoff120(event)' value='最多输入120字'/></div>"
										 	+"<div class='downbox mt18'><span class='fl wenben86left'>实施路径：</span> <input type='text' class='fl wenbenkuang670' id='new_sslj'  maxlength='120' style='background: transparent;float:left;color:#BCBCBC;cursor:text;' onfocus='turnon120(event)' onblur='turnoff120(event)' value='最多输入120字'/></div>"
										 	+"<div class='downbox mt18'><span class='fl wenben86left'>内容摘要：</span><textarea id='new_content' class='wenbenyu112' style='background: transparent; float:left;color:#BCBCBC;cursor:text;' onfocus='turnon700(event)' onblur='turnoff700(event)'>最多输入700字</textarea></div>"
										 	...
										 	+"<span class='fl wenben86left' style='width=133px' >自我评价：</span><textarea class='wenbenyu111' id='new_contentapp' onblur='checksaveapp(event)' style='background: transparent;float:left;color:#BCBCBC;cursor:text;'  onfocus='turnon600(event)' >最多输入600字</textarea>"
										 	+"<input type='button' title='删除' id='new_deleteapp' class='del fl ml10' onclick='deletepracticeappraisal(event)'  style='margin-top:45px;margin-left:1px;'/>"
										 	+"<input type='button' title='添 加' style='margin-left:91.05%' id='new_addapp' class='xgg fl ml10'  onclick='addtextarea(event)' /></div>"
										 	+"</td><td width='"+width+"' height='191' class='bg_eee' id='bg_eee_4_2'>"
										 	+"<input type='button' class='fr shanchu1' title='删除' id='new_delete' onclick='deleteselfall(event)' style='margin:0px auto;float:none'/>"
										 	+"<input type='button' class='fr tianjia' title='保存'  style='margin:0px auto;float:none' id='new_save' onclick='check(event)'/>"
										 	+"</td></tr>"
...
function dodown(attachid,foreignKey)
{
	...
	function addnew(){
		var width = $("#bg_eee_4_2").attr("width");
		if($("#new_tr").val()==undefined||$("#new_tr").val()==null){
...
//更改学期刷新页面
		...
		function changeBackgroundtd(id)
		{
			...
			if($("#new_contentapp1").val()=="最多输入600字"){
				$("#new_contentapp").val("");
				$("#new_contentapp").removeAttr("style"); 
				$("#new_contentapp").css({background:"transparent",color:"black",float:"left",cursor:"text"});
				
				$("#new_contentapp1").val("");
				$("#new_contentapp1").removeAttr("style"); 
				$("#new_contentapp1").css({background:"transparent",color:"black",float:"left",cursor:"text"});
			...
			if((!$("#"+id+"_tm").is(":focus"))&&$("#"+id+"_tm").val() ==""){
				$("#"+id+"_tm").val("最多输入30字");
			 	$("#"+id+"_tm").css({color:"#BCBCBC",float:"left",cursor:"text"}); 
			}
			if((!$("#"+id+"_hhr").is(":focus"))&&$("#"+id+"_hhr").val() ==""){
				$("#"+id+"_hhr").val("最多输入120字");
			 	$("#"+id+"_hhr").css({color:"#BCBCBC",float:"left",cursor:"text"}); 
			}
		...
		function turnon700(event){
			...
			if($("#"+idd).val()=="最多输入700字"){
				$("#"+idd).val("");
				/* $("#"+idd).css("marginLeft") = "86px"; */
			}
		}
		function turnoff700(event){
			var event = event || window.event;
			var obj=event.srcElement ? event.srcElement : event.target;
			var idd=obj.getAttribute('id');
			if ($("#"+idd).val() ==""){

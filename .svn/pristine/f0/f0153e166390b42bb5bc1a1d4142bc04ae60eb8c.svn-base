...
public class XMLProperties
{
     ...
     * @return the value of the specified property. �÷�: XMLProperties properties =
     *         new XMLProperties(�ļ���); String server =
     *         properties.getProperty("database.server"); String port =

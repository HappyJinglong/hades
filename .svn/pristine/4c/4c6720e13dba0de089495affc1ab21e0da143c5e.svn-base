...
<div style="top:110px;overflow-x:hidden;margin-bottom: 39px;height:500px;margin-right:-16px;">
  <table width="100%" border="0" cellspacing="1" bgcolor="#999999" class="biaoge"> -->
  <tr>
  ...
  <tr>
   ...
   <c:forEach items="${gradeYears}" var="gradeyear">
    ...
    <tr>
      ...
      <td>学生总人数</td>
   <c:forEach items="${gradeYears}" var="gradeyear">
	      <td>${datas[HZ_TRPJ_TX]["totalStudentNum"][gradeyear] }</td>
   </c:forEach>
    </tr>
    <tr>
      <td>已完成学生数<a id="1006"></a></td>
    <c:forEach items="${gradeYears}" var="gradeyear">
	      <td>${datas[HZ_TRPJ_TX]["overStudentNum"][gradeyear] }</td>
   	</c:forEach>
    </tr>
    <tr>
      <td>完成百分比（%）</td>
    <c:forEach items="${gradeYears}" var="gradeyear">
	      <td>${datas[HZ_TRPJ_TX]["percentOverStudentNum"][gradeyear] }</td>
   	</c:forEach>
    </tr>
        <tr>
   ...
   <c:forEach items="${gradeYears}" var="gradeyear">
    ...
    <tr>
      <td rowspan="3"><a id="1007"></a>审美与表现</td>
   ...
   <c:forEach items="${gradeYears}" var="gradeyear">
    ...
    <tr>
      ...
      <td>学生总人数</td>
   <c:forEach items="${gradeYears}" var="gradeyear">
	      <td>${datas[ZHSJ_YJXX_JBQK]["totalStudentNum"][gradeyear] }</td>
   </c:forEach>
    </tr>
    <tr>
      <td>已完成学生数</td>
    <c:forEach items="${gradeYears}" var="gradeyear">
	      <td>${datas[ZHSJ_YJXX_JBQK]["overStudentNum"][gradeyear] }</td>
   	</c:forEach>
    </tr>
    <tr>
      <td>完成百分比（%）</td>
    <c:forEach items="${gradeYears}" var="gradeyear">
	      <td>${datas[ZHSJ_YJXX_JBQK]["percentOverStudentNum"][gradeyear] }</td>
   	</c:forEach>
    </tr>
    <tr>
      ...
      <td>学生总人数</td>
   <c:forEach items="${gradeYears}" var="gradeyear">
	      <td>${datas[GXFZ_ZWPJ]["totalStudentNum"][gradeyear] }</td>
   </c:forEach>
    </tr>
    <tr>
      <td>已完成学生数</td>
     <c:forEach items="${gradeYears}" var="gradeyear">
	      <td>${datas[GXFZ_ZWPJ]["overStudentNum"][gradeyear] }</td>
   	</c:forEach>
    </tr>
    <tr>
      <td>完成百分比（%）</td>
    <c:forEach items="${gradeYears}" var="gradeyear">
	      <td>${datas[GXFZ_ZWPJ]["percentOverStudentNum"][gradeyear] }</td>
   	</c:forEach>
    </tr>
    <tr>

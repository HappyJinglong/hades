...
public class DiscodeNeedAppraisesAction extends BaseAction {
	...
	private Object queryWhichOnePage() {
		...
		if(Constant.DICT_TYPE_LEVELCODE_GZSTR.equals(levelCode)
			...
			return "discodehighindex.jsp";
		}else{
			return "discodemidleindex.jsp";
		}
	}
	public Object queryData(HttpServletRequest req){
		queryBaseData(req);
		datas=studentAppDetailExt.queryMapDataByConditionInDiscode(termId,gradeid,userDto.getDiscode(),levelCode,schoolName,tongjiDatas);

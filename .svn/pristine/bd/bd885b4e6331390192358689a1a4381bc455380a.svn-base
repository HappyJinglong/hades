...
function forward(){
	...
	if(commonFuncId=='null'||commonFuncId==''||commonFuncId=='4020'||commonFuncId=='3020'){
		id="student";
		$("#"+id).attr("href","${ctx }/middlemaster/StudentApprisedAction.a?DefaultEduId");
	}else{
...
var timeId = setInterval("clearTimeId()",5);
  function showStudentMenu(){
	  self.parent.frames[2].ShowDiv && self.parent.frames[2].ShowDiv();
	    ...
	    $("#student").attr("href","${ctx }/middlemaster/StudentApprisedAction.a?DefaultEduId");
  }
  function showTeacherMenu(){
	  self.parent.frames[2].ShowDiv && self.parent.frames[2].ShowDiv();
	    ...
	    $("#teacher").attr("href","${ctx }/middlemaster/QueryCommentAction.a?sectionCode=1");
  }
...
<div id="pj_menu2"  style="display:none;"> 
   ...
   <li class="cur"><a href="${ctx }/middlemaster/QueryCommentAction.a?sectionCode=1" <c:if test="${ empty commonFuncId or commonFuncId eq '4020' or commonFuncId eq '3020'}">id="student"</c:if> <c:if test="${not empty commonFuncId and commonFuncId ne '4020' and commonFuncId ne '3020'}">id="student1001"</c:if> target="main"  onclick="changeAStyle($(this))"><img src="${ctx}/images/xieks.png">新学期伊始的我&nbsp;<span class="red">*</span></a></li> 
            <li><a href="${ctx }/middlemaster/QueryCommentAction.a?sectionCode=2" <c:if test="${ empty commonFuncId}">id="student"</c:if> <c:if test="${not empty commonFuncId}">id="student1002"</c:if> target="main"  onclick="changeAStyle($(this))"><img src="${ctx}/images/xiejs.png">学期结束时的我&nbsp;<span class="red">*</span></a></li> 
            <li><a href="${ctx }/middlemaster/QueryCommentAction.a?sectionCode=3" <c:if test="${ empty commonFuncId}">id="student"</c:if> <c:if test="${not empty commonFuncId}">id="student1003"</c:if> target="main"  onclick="changeAStyle($(this))"><img src="${ctx}/images/xiesx.png">思想道德&nbsp;<span class="red">*</span></a></li> 
            <li><a href="${ctx }/middlemaster/QueryCommentAction.a?sectionCode=4" <c:if test="${ empty commonFuncId}">id="student"</c:if> <c:if test="${not empty commonFuncId}">id="student1004"</c:if> target="main"  onclick="changeAStyle($(this))"><img src="${ctx}/images/xiecj.png">学业成就&nbsp;<span class="red">*</span></a></li> 
            <li><a href="${ctx }/middlemaster/QueryCommentAction.a?sectionCode=5" <c:if test="${ empty commonFuncId}">id="student"</c:if> <c:if test="${not empty commonFuncId}">id="student1005"</c:if> target="main"  onclick="changeAStyle($(this))"><img src="${ctx}/images/xiehz.png">合作与交流&nbsp;<span class="red">*</span></a></li> 
            <li><a href="${ctx }/middlemaster/QueryCommentAction.a?sectionCode=6" <c:if test="${ empty commonFuncId}">id="student"</c:if> <c:if test="${not empty commonFuncId}">id="student1006"</c:if> target="main"  onclick="changeAStyle($(this))"><img src="${ctx}/images/xieyd.png">运动与健康&nbsp;<span class="red">*</span></a></li> 
            <li><a href="${ctx }/middlemaster/QueryCommentAction.a?sectionCode=7" <c:if test="${ empty commonFuncId}">id="student"</c:if> <c:if test="${not empty commonFuncId}">id="student1007"</c:if> target="main"  onclick="changeAStyle($(this))"><img src="${ctx}/images/xiesm.png">审美与表现&nbsp;<span class="red">*</span></a></li> 
            <li><a href="${ctx }/middlemaster/QueryCommentAction.a?sectionCode=8" <c:if test="${ empty commonFuncId}">id="student"</c:if> <c:if test="${not empty commonFuncId}">id="student1008"</c:if> target="main"  onclick="changeAStyle($(this))"><img src="${ctx}/images/xiesh.png">综合实践活动&nbsp;<span class="red">*</span></a></li> 
            <li><a href="${ctx }/middlemaster/QueryCommentAction.a?sectionCode=9" <c:if test="${ empty commonFuncId}">id="student"</c:if> <c:if test="${not empty commonFuncId}">id="student1009"</c:if> target="main"  onclick="changeAStyle($(this))"><img src="${ctx}/images/xiegx.png">个性发展&nbsp;<span class="red">*</span></a></li> 
    </ul>
</div>

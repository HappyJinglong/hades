...
<script type="text/javascript">
 	function forwardStuInfoPage(stuId,key,name){
 		self.frames[2].ShowDiv && self.frames[2].ShowDiv();
		var mF = document.getElementById('mainFrame');
		mF.src ='${ctx}/student/ZtreeAction.a?evaluatedPersonID='+stuId;
	}
</script>

 <frameset border="0px" cols="250px,11px,*">
		<frame name="left" frameborder="0" noresize="0" src="shiyangzleft.jsp">
		...
		<!-- <frame name="main"  id="mainFrame" frameborder="0"  noresize="0" src="GzTreeShowAction.a"> -->
	</frameset>

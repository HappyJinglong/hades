	...
	getNode : function(e) {
		...
		if (t = e.getTarget('.x-tree-node-el', 10)) {
			var id = Ext.fly(t, '_treeEvents').getAttributeNS('ext',
					'tree-node-id') || t.getAttribute('ext:tree-node-id');
			if (id) {
...
Ext.tree.TreeNodeUI.prototype = {
	...
	renderElements : function(n, a, targetNode, bulkRender) {
		...
		var buf = [
				...
				/*if(n.text.length>3){
					var st = n.text.substring(0,3),
					 st += "..."
					'><span unselectable="on" title="'+n.text+'" >', st, "</span></a></div>",
				}else{	
					'><span unselectable="on" title="'+n.text+'" >', n.text, "</span></a></div>",
					}*/
				'><span unselectable="on" title="'+n.text+'" >', n.text, "</span></a></div>",

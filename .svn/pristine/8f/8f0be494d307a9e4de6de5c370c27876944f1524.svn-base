<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<un:bind var="TYPE_START_ZWPJ" type="com.flyrish.hades.common.Constant"
	field="TYPE_START_ZWPJ" />
	<un:bind var="TYPE_START_WDFZMB" type="com.flyrish.hades.common.Constant"
...
<input type="hidden" name="evaluateType1" id="evaluateType1" value="${TYPE_START_ZWPJ}"> 
<input type="hidden" name="evaluateType2" id="evaluateType2" value="${TYPE_START_WDFZMB}"> 

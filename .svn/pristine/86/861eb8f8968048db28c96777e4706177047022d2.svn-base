...
function addContent(parentDiv,currentObj){
	...
	var tmp= '<table  class="xiechengsheng4" cellspacing="0" id="'+sid+'_tab">' 
		...
		+'</textarea>'
		+'<div class="fr btn" id="shanchu_btn" name ="shanchu_btn" style="width:'+width+';"><input id="'+blank+'_delete" class="fr shanchu" type="button" style="margin-top:30px;margin-right:20px;" onclick="delete_content($(this),$(\'#'+sid+'_singleStu\'))"/></div></div>'
...
$(document).ready(function(){
	...
	for(var i=0;i<texts.size();i++){
		if(sectionCode=="2030"){
			input_noticemaster($(texts[i]).attr("id"),300)
		}else{

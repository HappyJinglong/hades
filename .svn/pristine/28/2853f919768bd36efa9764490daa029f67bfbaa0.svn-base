...
public class CityNeedAppraisesAction extends BaseAction {
	...
	private Object queryWhichOnePage() {
		...
		if(Constant.DICT_TYPE_LEVELCODE_GZSTR.equals(levelCode)
			...
			return "cityhighindex.jsp";
		}else{
			return "citymidleindex.jsp";
		}
	}
	public Object queryData(HttpServletRequest req){
		queryBaseData(req);
		datas=studentAppDetailExt.queryMapDataByConditionInDiscode(termId,gradeid,discode,levelCode,schoolName,tongjiDatas);

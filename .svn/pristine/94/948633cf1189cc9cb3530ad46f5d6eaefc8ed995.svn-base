<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<un:bind var="TYPE_END_ZWPJ" type="com.flyrish.hades.common.Constant"
	field="TYPE_END_ZWPJ" />
	<un:bind var="TYPE_END_WDFZMB" type="com.flyrish.hades.common.Constant"
...
<input type="hidden" name="evaluateType1" id="evaluateType1" value="${TYPE_END_ZWPJ}"> 
<input type="hidden" name="evaluateType2" id="evaluateType2" value="${TYPE_END_WDFZMB}"> 
<input type="hidden" name="choicenum" id="choicenum" value="${choicenum}"> 
<input type="hidden" name="date" id="date" value="${date}"> 
	<div class="dangqianwz">
 	<span class="fl">当前位置：自我评价->学期结束时的我</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  		<span>学期：
		...
		<%int n=1;%>
			...
			<div id="old_top" <c:if test="${empty appraisalList1}">style='display:none'</c:if>>
				<table width="100%" border="0" cellspacing="1" bgcolor="#999999"
					...
					<tr>
						<td colspan="3" id="${list.apprasialid}_td" class="pl20 pr20 pb20 pt10 zuojuzhong " style="background:#eee;">
					...
					<tr id="old_addlocation">
					    <td colspan="3" class="bg_eee h80">
				            <div class="fr btn">
				             <input type="button" style="margin:0px auto;float:none;margin-right:18px;" class="fr shanchu1" id="${list.apprasialid}_delete" title="删除" onclick="deleteselfapp(this)"/>
				            </div>
				         </td>
					</tr>
					</c:forEach>
		...
		<c:if test="${empty appraisalList2}">
			...
			<div id="old_down" >
				<table width="100%" border="0" cellspacing="1" bgcolor="#999999"
					...
					<tr id="${list.apprasialid}_tr">
					  	<td width="10%" height="40" class="bg_eee" id="${list.apprasialid}_num"><%=j%></td>
						<td colspan="2" class="youjuzhong pr20 bg_eee">
						评价人：本人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						签名：${evaluatePersonName} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						日期：<input id="${list.apprasialid}_startDate" type="text"  value="${list.signdate}" size="10" onchange="doupdate3('${list.apprasialid}')" onClick="WdatePicker()"/> 
						</td>
					</tr>
					<tr>
						<td colspan="3" id="${list.apprasialid}_td" class="pl20 pr20 pb20 pt10 zuojuzhong " style="background:#eee;">
				 			 <textarea class="content"
						                ...
						                style="background: transparent;  border: 1px solid transparent; overflow:auto; height: 130px; width: 100%; "
						                idvalue="${list.apprasial}"
						                onblur="doupdate2('${list.apprasialid}')"
						                onfocus="changeback(this)">${list.apprasial}</textarea>
						</td>
					</tr>
					<%j++;%>
					<tr id="new_addlocation2">
					    <td colspan="3" class="bg_eee h80">
				            <div class="fr btn">
				             <input type="button" style="margin:0px auto;float:none;margin-right:18px;" class="fr shanchu1" id="${list.apprasialid}_delete" title="删除" onclick="deleteselfapp2(this)"/>
				            </div>
				         </td>
					</tr>
					</c:forEach>
	 ...
	 function addnew(trid,div){
		 if(document.getElementById("new_tr1")==null){
			 var div = document.getElementById(div); 
				...
				$("#"+trid).before(str);
				input_notice("new_content11",300);
				tr_num = 0;
		 }
	} 
		...
		if(idi!="new"){
			...
			if(id=="new_content1"){
				...
				if($("#new_content2")!=null&&$("#new_content2").val()!=undefined){
					...
					clear_notice1("new_content2",300);
				}
			}
		}
	}

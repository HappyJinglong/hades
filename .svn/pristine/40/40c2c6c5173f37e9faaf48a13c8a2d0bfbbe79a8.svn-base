...
<un:bind var="WORKS_SELF_APPRAISAL" type="com.flyrish.hades.common.Constant" field="WORKS_SELF_APPRAISAL" />
<un:bind var="WORKS_SUBJECT_SHOW" type="com.flyrish.hades.common.Constant" field="WORKS_SUBJECT_SHOW" />
...
<input type="hidden" name="evaluateType1" id="evaluateType1" value="${WORKS_SELF_APPRAISAL}"> 
<input type="hidden" name="evaluateType2" id="evaluateType2" value="${WORKS_SUBJECT_SHOW}"> 
				...
				<table width="100%" border="0" cellspacing="1" bgcolor="#999999"
					...
					<tr>
						<td id ="new_td" colspan="2" class="pl20 pr20 pb20 pt10 zuojuzhong">
							<textarea id="new_content1" style="background: transparent; overflow:auto; border: 1px solid transparent; height: 130px; width: 100%;" onblur="checksave('new_startDate1','new_content1',this)" onfocus="changeback(this)"></textarea>
						</td>
					...
					<tr>
						<td colspan="2" class="h50" id ="new_td2" style="width: 90%;">
                    		...
                    		<span class="fl wenben85left">科目：&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    			<div align="left">
                    			<select name="new_subjectName" id="new_subjectName"  style="background: transparent; border:1px solid #999;width:20%;">
						...
						<td width="10%" height="191" id="bg_eee_2_5" class="bg_eee" style="margin:0px auto;float:none">
				...
				<table width="100%"  id="new_table2" border="0" cellspacing="1" bgcolor="#999999"
					...
					<c:forEach items="${appraisalList2}" var="list" varStatus="status">
						...
						<tr>
							...
							<div class="downbox mt18">
								<span class="fl wenben85left">主题：&nbsp;&nbsp;&nbsp;&nbsp;</span> 
								<input type="text" style="background: transparent;" maxlength="25" class="fl wenbenkuang670" id="${list.part_id}_topic" value="${list.topic}"  onfocus="turnon1('${list.part_id}_topic',this)" onblur="turnoff1('${list.part_id}_topic',this)" onclick="changeBackgroundtd('${list.part_id}')"/>
							</div>
							<div class="downbox mt18">
                    		<span class="fl wenben85left">科目：&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    			<div align="left">
                    			<select name="${list.part_id}_subjectName" id="${list.part_id}_subjectName" style="background: transparent;border:1px solid #999;width:20%;" onclick="changeBackgroundtd('${list.part_id}')">
		               				<app:subjectSelectTag levelCode="${levelcode}" subjectId="${list.subject_id}"/>
		              			</select>
		              			</div>
               				 </div>
								<div class="downbox mt18">
						...
						if(document.getElementById(valuenum).value.length<=600){
							...
							Ext.Ajax.request({
								...
								success:function(response,options){
									...
									if(response.responseText=="##"){
										...
										if(check!="0"){
											...
											$("#"+saveid+"_content").css({background:"transparent",color:"#BCBCBC",float:"left",cursor:"text"});
											}
										...
										if(check!="1"){
											...
											$("#"+saveid+"_content").css({background:"transparent",float:"left",cursor:"text"});
											$("#"+saveid+"_topic").bind("focus",function(){
												changeBackgroundtd(saveid);
											});
											$("#"+saveid+"_subjectName").bind("focus",function(){
												changeBackgroundtd(saveid);
											});
								...
								params : {
									...
									subject_id : document.getElementById("new_subjectName").value,
									evaluateType1 : type1,
									evaluateType2 : type2,
								...
								if(pname.length<=25){
									if((ftype!=null&&ftype!="")&&(ftype=="doc"||ftype=="docx"||ftype=="txt"||ftype=="jpg"||ftype=="pdf"||ftype=="pps"||ftype=="ppsx"||ftype=="ppt"||ftype=="pptx")){
										...
										if(isrepeat!=1){
											...
											alert("学科作品展示 栏目"+$("#"+id+"_num").html()+": 附件名重复!");
											$("#"+id+"_upload").attr("disabled",false);
											$('#old_fileField').attr("id",beforeid);
										}
												...
												$("#"+idd+"_tr").remove();
												 ...
												 str+="<tr id='new_tr2'><td width='10%' height='40' id='new_num2' class='bg_eee'>1</td><td colspan='2' class='youjuzhong pr20 bg_eee'>"
													...
													+"</td></tr><tr><td colspan='2' id='new_td2' class='h50' style='width: 90%;'><div class='downbox mt18'>"
												 	...
												 	+"<div class='downbox mt18'><span class='fl wenben85left'>科目：&nbsp;&nbsp;&nbsp;&nbsp;</span><div align='left'><select name='new_subjectName' id='new_subjectName'  style='border:1px solid #999;background: transparent;width:20%;'>"
													...
													+"</select></div></div>"
												 	...
												 	+"</form></div></td><td id='bg_eee_2_5' height='191' class='bg_eee' style='margin:0px auto;float:none' >"
						...
						if(document.getElementById(idi+"_content").value.length<=4000){
							...
							Ext.Ajax.request({
								...
								params : {
									...
									subject_id : document.getElementById(idi+"_subjectName").value,
									evaluateType1 : type1,
									evaluateType2 : type2,
									evaluateType : type,
									termId : document.getElementById("termId").value,
							...
							var v_url='${ctx}/partinfo/PartinfoAction.a?doUpdataSelfPartInfo'
								  Ext.Ajax.request({
										...
										params : {
											...
											termId : document.getElementById("termId").value,
											subject_id : document.getElementById(id+"_subjectName").value,
		 ...
		 function addnew(trid,div){
			 ...
			 if(document.getElementById("new_tr1")==null){
				 var div = document.getElementById(div); 
					...
					+"</td><td width='"+width+"' id='bg_eee_2_1' class='bg_eee'><span class='fr btn'  style='margin:0px auto;float:none'><input type='button' class='fr shanchu1' style='margin:0px auto;float:none' title='删除' id='new_delete1' onclick='deleteselfapp(this)'/></span></td></tr>";
					$("#"+trid).before(str);
